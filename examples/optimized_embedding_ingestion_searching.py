...
def create_base_dag():
    ...
    passages_embedding_node = Node(
        ...
        config={
            "batch_size": embed_config.model_config.get("max_batch_size", 1024)
        }
    )
    ...
    base_dag.register_nodes(passages_embedding_node, ingestion_node, query_embedding_node, search_node)
