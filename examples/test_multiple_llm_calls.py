...
def create_base_dag():
    ...
    answer_prefilling_node = Node(
        ...
        io_schema=NodeIOSchema(
            ...
            output_format={"answer_prefill_state": bool}
        ),
    ...
    answer_decoding_node = Node(
        ...
        engine_type=EngineType.LLM,
        io_schema=NodeIOSchema(
            input_format={"answer_prefill_state": bool},
    ...
    # Connect nodes
    answer_prefilling_node >> answer_decoding_node >> enrich_prefilling_node >> enrich_decoding_node
