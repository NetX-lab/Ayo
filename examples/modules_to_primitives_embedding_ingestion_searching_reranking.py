...
reranking_module=RerankingModule(input_format={"query": str,"searching_results": List[str]}, output_format={"reranking_results": List[str]})
...
dag.register_nodes(*indexing_nodes,*query_expanding_nodes,*searching_nodes,*reranking_nodes)
