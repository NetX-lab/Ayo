...
class InputMetadata:
    ...
    def __init__(
        ...
        block_tables_contain_prompt: bool = False,
    ) -> None:
        self.seq_groups = seq_groups
        self.seq_data = seq_data
        self.prompt_lens = prompt_lens
        self.context_lens_for_prompts = context_lens_for_prompts
        ...
        if block_tables_contain_prompt:
            assert block_tables.shape[0] == self.num_prompts+self.num_generation_tokens
        else:
    ...
    def __repr__(self) -> str:
        ...
        return (
            ...
            f'context_lens_for_prompts={self.context_lens_for_prompts}, '
