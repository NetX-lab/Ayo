    ...
    def to_primitive_nodes(self):
        ...
        llm_prefilling_node = Node(
            ...
            io_schema=NodeIOSchema(
                ...
                output_format={"prefill_state": dict}
            ),
            op_type=NodeOps.LLM_PREFILLING,
            engine_type=EngineType.LLM,
            node_type=NodeType.COMPUTE,
            config={
                'prompt_template': self.config.get('prompt_template', self.prompt_template),
                ...
                'llm_partial_decoding_idx': self.config.get('llm_partial_decoding_idx', -1),
